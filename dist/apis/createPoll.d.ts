...
export declare const createPollFactory: (ctx: import("../context.js").ContextBase, api: import("../zalo.js").API) => (options: CreatePollOptions, groupId: string) => Promise<PollDetail>;
