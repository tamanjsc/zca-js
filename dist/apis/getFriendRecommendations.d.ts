...
export declare const getFriendRecommendationsFactory: (ctx: import("../context.js").ContextBase, api: import("../zalo.js").API) => () => Promise<GetFriendRecommendationsResponse>;
